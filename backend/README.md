...
## Project Structure
    ...
    ├── testapiautoconnect_119862  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_119862`
...
2. Clone this repo and `cd testapiautoconnect_119862`
